...
public class OceanBaseMySqlDatabaseDialectTest extends BaseDialectTest<OceanBaseMysqlDatabaseDialect> {

  @Override
  protected OceanBaseMysqlDatabaseDialect createDialect() {
    return new OceanBaseMysqlDatabaseDialect(sourceConfigWithUrl("jdbc:oceanbase://something"));
  }
