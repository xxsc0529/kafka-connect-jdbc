...
public class OceanBaseOracleDatabaseDialectTest extends BaseDialectTest<OceanBaseOracleDatabaseDialect> {

  @Override
  protected OceanBaseOracleDatabaseDialect createDialect() {
    return new OceanBaseOracleDatabaseDialect(sourceConfigWithUrl("jdbc:oceanbase://something"));
  }
