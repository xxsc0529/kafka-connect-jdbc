...
package io.confluent.connect.oceanbase.source;
...
import io.confluent.connect.oceanbase.dialect.DatabaseDialect;
import io.confluent.connect.oceanbase.dialect.DatabaseDialects;
import io.confluent.connect.oceanbase.util.DatabaseDialectRecommender;
...
import io.confluent.connect.oceanbase.util.EnumRecommender;
import io.confluent.connect.oceanbase.util.JdbcCredentialsProvider;
import io.confluent.connect.oceanbase.util.JdbcCredentialsProviderValidator;
import io.confluent.connect.oceanbase.util.QuoteMethod;
import io.confluent.connect.oceanbase.util.TimeZoneValidator;
...
public class JdbcSourceConnectorConfig extends AbstractConfig {
  ...
  private static final String CONNECTION_URL_DOC =
      "JDBC connection URL.\n"
          ...
          + "``jdbc:oceanbase://localhost/db_name``,"
  ...
  public Config validateMultiConfigs(Config config) {
    ...
    if (transactionIsolationMode == TransactionIsolationMode.SQL_SERVER_SNAPSHOT) {
      ...
      if (dialectName != null && !dialectName.trim().isEmpty()) {
        ...
        dialect = DatabaseDialects.findBestFor(this.getString(CONNECTION_URL_CONFIG),
                this.getString(CONNECTION_USER_CONFIG),
                this.getPassword(CONNECTION_PASSWORD_CONFIG).value(),this);
      }
