...
import io.confluent.connect.oceanbase.dialect.DatabaseDialectProvider.SubprotocolBasedProvider;
 ...
 */
public class OceanBaseOracleDatabaseDialect extends GenericDatabaseDialect {

  /**
   * The provider for {@link OceanBaseOracleDatabaseDialect}.
   */
  public static class Provider extends SubprotocolBasedProvider {
    public Provider() {
      super(OceanBaseOracleDatabaseDialect.class.getSimpleName(), "oceanbase","oceanbase:oracle");
    }

    @Override
    public DatabaseDialect create(AbstractConfig config) {
      return new OceanBaseOracleDatabaseDialect(config);
    }
  }
   ...
   */
  public OceanBaseOracleDatabaseDialect(AbstractConfig config) {
