...
/**
 * A {@link DatabaseDialect} for OceanBase.
 */
public class OceanBaseMysqlDatabaseDialect extends GenericDatabaseDialect {

  private final Logger log = LoggerFactory.getLogger(OceanBaseMysqlDatabaseDialect.class);

  /**
   * The provider for {@link OceanBaseMysqlDatabaseDialect}.
   */
  public static class Provider extends SubprotocolBasedProvider {
    public Provider() {
      super(OceanBaseMysqlDatabaseDialect.class.getSimpleName(), "oceanbase", "mysql");
    }

    @Override
    public DatabaseDialect create(AbstractConfig config) {
      return new OceanBaseMysqlDatabaseDialect(config);
    }
  }
   ...
   */
  public OceanBaseMysqlDatabaseDialect(AbstractConfig config) {
